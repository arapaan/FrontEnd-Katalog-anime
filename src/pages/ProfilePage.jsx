...
export default function ProfilePage() {
    return (
        <div className='px-2 py-3'>
            ...
            <div className='flex gap-2 text-white font-light md:text-3xl flex-col relative justify-center items-center'>
            ...
            <div className='flex justify-center md:gap-20 md:text-xl items-center text-white gap-4'>
