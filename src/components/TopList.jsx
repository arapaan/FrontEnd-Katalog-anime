        ...
        <div className="flex flex-col text-white justify-start">
            ...
            <div className='relative mt-5'>
                <div className="flex flex-nowrap gap-5 overflow-x-auto">
                    <div className='w-full h-[490px] rounded-xl relative overflow-hidden'>                    
                        ...
                        <div className='absolute inset-0 flex flex-col justify-center items-center z-20'>
                            <div className='flex flex-col justify-between z-30 items-end w-40 h-[290px] bg-cover rounded-lg' style={{ backgroundImage: `url(${top1})` }}>
                                ...
                                <span className='flex rounded-b-lg items-end bg-gradient-to-b from-black/10 to-black h-[50%] w-full'> <span className='px-2 py-2'>Eps 12</span> </span>
                            </div>
                    ...
                    <div className='w-full px-3'>
                        <div className='w-full h-[245px] rounded-xl relative overflow-hidden'>                    
                            <div className='absolute inset-0 bg-cover bg-center z-0' 
